...
int main(int argc, char *argv[])
{
    ...
    int  step = 10;
    char * pImg = "./assets/face_detection.jpg";
    ...
    read_img(pImg,&image_pointer,&img_width,&img_height);
    ...
    time(&startTime);
    cout<<*image_pointer<<endl;
    int * result = MBLBPDetectMultiScale_Multiview(image_pointer, img_width, img_height, 150, pCascades, angles, 1,1126, min_neighbors, min_size, max_size,flips_ptr);
    time(&endTime);
    cout<<*result<<endl;
    return 0;
}
